export { AppStoreIcon } from './stores-icons/ui/App-Store-icon'
export { GOGIcon } from './stores-icons/ui/gog-icon'
export { GooglePlayIcon } from './stores-icons/ui/google-play-icon'
export { NintendoSwitchIcon } from './stores-icons/ui/nintendo-switch-icon'
export { PlaystationIcon } from './stores-icons/ui/playstation-icon'
export { SteamIcon } from './stores-icons/ui/steam-icon'
export { Xbox360Icon } from './stores-icons/ui/xbox-360-icon'
export { XboxIcon } from './stores-icons/ui/xbox-icon'
